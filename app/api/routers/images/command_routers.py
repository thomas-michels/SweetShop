...
# from app.crud.images import Expense, ExpenseInDB, UpdateExpense, ExpenseServices

router = APIRouter(tags=["Images"])


# @router.post("/images", responses={201: {"model": ExpenseInDB}})
...
# @router.put("/images/{expense_id}", responses={200: {"model": ExpenseInDB}})
...
# @router.delete("/images/{expense_id}", responses={200: {"model": ExpenseInDB}})
