...
class TermOfUseAcceptanceRepository(Repository):
    async def create(
        self, term_of_use_acceptance: TermOfUseAcceptance
        ...
        try:
            ...
            _logger.warning(
                f"TermOfUseAcceptance already accepted for user {term_of_use_acceptance.user_id}"
            )
            return await self.select_by_id(id=term_of_use_acceptance_model.id)
    ...
    async def select_by_id(self, id: str) -> TermOfUseAcceptanceInDB:
        try:
            term_of_use_acceptance_model: TermOfUseAcceptanceModel = (
                TermOfUseAcceptanceModel.objects(
                    id=id,
                    is_active=True,
                ).first()
            )
    ...
    async def select_by_term_and_user(
        ...
        try:
            ...
            if term_of_use_acceptance_model:
                return TermOfUseAcceptanceInDB.model_validate(
                    term_of_use_acceptance_model
                )
    ...
    async def delete(
        self, acceptance: TermOfUseAcceptanceInDB
    ) -> TermOfUseAcceptanceInDB:
        try:
            term_of_use_acceptance_model: TermOfUseAcceptanceModel = (
                TermOfUseAcceptanceModel.objects(
